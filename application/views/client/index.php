                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <div class="pt-4 pb-2">
                        ...
                        <p class="text-center small">Enter your phone number</p>
                      </div>
                      <?php if(isset($error)){?>
                          <div style="color:red"><?= $error?></div>
                      <?php }?>

                    <form class="row g-3 needs-validation" action="<?= site_url("C_Client/login")?>" method="post" novalidate>
                        
                        <div class="col-12">
                          <label for="email" class="form-label">Number</label>
                          <?php if(isset($num)){?>
                            <input type="text" name="num"  value="<?= $num?>" class="form-control" id="enum"  required>
                            <?php }else{?>
                              <input type="text" name="num" class="form-control" id="enum" placeholder="034 ** *** **" required>
                            <?php } ?>
