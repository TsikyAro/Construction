<!DOCTYPE html>
    ...
    <body>
      ...
      <main>
        <div class="container">
        <!-- <form action="<?= base_url("index.php/ExportCsv/import")?>" method="post"  enctype="multipart/form-data">
                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <form class="row g-3 needs-validation" action="<?= site_url("AccountController/login")?>" method="post" novalidate>
                        
                        <div class="col-12">
                          <label for="email" class="form-label">E-Mail</label>
                          <?php if(isset($mail)){?>
                            <input type="email" name="mail"  value="<?= $mail?>" class="form-control" id="email" required>
                            <?php }else{?>
                        ...
                        <div class="col-12">
                          ...
                          <?php if(isset($mdp)){?>
                              <input type="password" name="mdp" value=<?= $mdp?> class="form-control" id="yourPassword" required>
                            <?php }else{?>
                        ...
                        <div class="col-12">
                          <p class="small mb-0">Don't have account? <a href="<?= base_url("index.php/AccountController/signin")?>">Create an account</a></p>
                        </div>
                      </form>
